...
tko source add fup @fup # para carregar todas as atividades de fup
tko source add ed @ed # para carregar todas as atividades de ed
tko source add poo @poo # para carregar todas as atividades de poo
