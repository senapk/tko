...
class TaskTree:
    ...
    def str_task(self, in_focus: bool, t: Task, lig_cluster: str, lig_quest: str, quest_reachable: bool, min_value=1) -> Sentence:
            ...
            for q in quests:
                ...
                if q.key in self.expanded:
                    for t in q.get_tasks():
                        ...
                        sentence = self.str_task(self.index_selected == index, t, ligc, ligq, q.is_reachable(), min_value)
