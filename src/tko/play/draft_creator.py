...
class DraftCreator:
    ...
    def create_draft(self):
        ...
        def __create(draft_title: str):
            ...
            fix_readme(index=index_file, base_dirs=[sandbox_folder], verbose=False, load_titles=True, yes=True)
        ...
        obj = FloatingInputText(RT(str(_DraftMsg.TITLE_PROMPT)), __create, current_folders_on_rep).set_id("drafts")
