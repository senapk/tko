...
class MiniwiBuilder:
    ...
    def __get_font(builder: Callable[[list[str]], str]) -> dict[str, str]:
        return  {
            ...
            "0": builder([ "0000", "1110", "1010", "1010", "1010", "1110", "0000", "0000", ]),
            "1": builder([ "0000", "0100", "1100", "0100", "0100", "1110", "0000", "0000", ]),
            "2": builder([ "0000", "1110", "0010", "1110", "1000", "1110", "0000", "0000", ]),
            "3": builder([ "0000", "1110", "0010", "1110", "0010", "1110", "0000", "0000", ]),
            "4": builder([ "0000", "1010", "1010", "1110", "0010", "0010", "0000", "0000", ]),
            "5": builder([ "0000", "1110", "1000", "1110", "0010", "1110", "0000", "0000", ]),
            "6": builder([ "0000", "1110", "1000", "1110", "1010", "1110", "0000", "0000", ]),
            "7": builder([ "0000", "1110", "0010", "0100", "1000", "1000", "0000", "0000", ]),
            "8": builder([ "0000", "1110", "1010", "1110", "1010", "1110", "0000", "0000", ]),
            "9": builder([ "0000", "1110", "1010", "1110", "0010", "1110", "0000", "0000", ]),
        }
