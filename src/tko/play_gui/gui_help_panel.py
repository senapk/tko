...
class _GuiHelpMsg:
    ...
    CALIBRATE_LINE = Msg(pt=" Calibrar [r]{}[] Para calibrar os direcionais do teclado", 
                         en=" Calibrate [r]{}[] To calibrate the keyboard arrow keys")

    SECTION_SYMBOLS = Msg(pt=" Símbolos ", en=" Symbols ")
    SYMBOL_STUDY_WRITE_NOHELP = Msg(pt=" [g]{}[] Estudo/Consulta, [y]{}[] Escrever e refazer, [r]{}[] Fazer sem consulta", 
    ...
    SECTION_NAVIGATION = Msg(pt=" Navegação ", 
                             en=" Navigation ")
    NAV_ARROWS = Msg(pt="  setas [r]{}[] Para navegar entre os elementos", 
                     en="  arrows [r]{}[] To navigate between elements")
    NAV_ENTER = Msg(pt="    Enter [r]{}[] Interage com o elemento de acordo com o contexto", 
                    en="    Enter [r]{}[] Interacts with the element depending on context")

    SECTION_INTERFACE = Msg(pt=" Interface ", 
                            en=" Interface ")
    INTERFACE_INBOX = Msg(pt="    Inbox [r]{}[] Mostra as tarefas sugeridas e iniciadas", 
                          en="    Inbox [r]{}[] Shows suggested and started tasks")
    INTERFACE_ALL = Msg(pt="    Todas [r]{}[] Mostra as todas tarefas cadastradas", 
                        en="    All [r]{}[] Shows all registered tasks")
    INTERFACE_PALETTE = Msg(pt="   Paleta [r]{}[] Abre o menu de ações e configurações", 
                            en="  Palette [r]{}[] Opens the actions and settings menu")
    INTERFACE_TIME = Msg(pt="    Tempo [r]{}[] Mostrar/Oculta o tempo gasto nas tarefas", 
                         en="     Time [r]{}[] Shows/Hides the time spent on tasks")
    INTERFACE_SEARCH = Msg(pt="    Busca [r]{}[] Abre a barra de pesquisa", 
                           en="   Search [r]{}[] Opens the search bar")

    SECTION_TASKS = Msg(pt=" Tarefas ", en=" Tasks ")
    TASK_DOWNLOAD = Msg(pt=" Download [r]{}[] Baixa novamente a tarefa selecionada", 
                        en=" Download [r]{}[] Downloads the selected task again")
    TASK_DELETE = Msg(pt="   Apagar [r]{}[] Apaga a pasta da tarefa selecionada", 
                      en="   Delete [r]{}[] Deletes the selected task folder")
    TASK_DRAFT = Msg(pt=" Rascunho [r]{}[] Cria um rascunho para escrever código ou anotações", 
                     en="    Draft [r]{}[] Creates a draft for code or notes")
    TASK_EVALUATION = Msg(pt="Avaliação [r]{}[] Abre tela para auto avaliação", 
                          en=" Evaluate [r]{}[] Opens self-evaluation screen")

    SECTION_DEFAULT_EDITOR = Msg(pt=" Editor padrão ", 
                                 en=" Default editor ")
    EDITOR_DESC = Msg(pt=" Para mudar o editor padrão para abrir arquivos use o comando", 
                      en=" To change the default editor used to open files, run")
    EDITOR_COMMAND = Msg(pt="tko config set --editor <comando>", 
