...
class GameBuilder:
    ...
    def build_from(self, content: str, folder: str):
        self.__parse_file_content(content)
        self.__parse_folder_for_user_tasks(folder)
        self.__clear_empty()
    ...
    def __parse_folder_for_user_tasks(self, folder: str):
