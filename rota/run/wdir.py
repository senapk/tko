...
from rota.util.identifier import Identifier

from rota.util.consts import IdentifierType
from rota.run.unit import Unit
from rota.util.param import Param
from rota.run.loader import Loader
from rota.run.solver_builder import SolverBuilder

from rota.down.drafts import Drafts
from rota.util.text import Text
from rota.util.symbols import symbols
from rota.util.label_factory import LabelFactory
from rota.settings.repository import available_languages
class Wdir:
    def __init__(self):
