...
from rota.util.consts import DiffCount, ExecutionResult
...
from rota.play.tester import Tester
...
class rotaFilterMode:
    @staticmethod
    def deep_copy_and_change_dir():
        # path to ~/.rota_filter
        filter_path = os.path.join(os.path.expanduser("~"), ".rota_filter")
...
class Run:
    ...
    def __change_targets_to_filter_mode(self):
        if self.param.filter:
            ...
            rotaFilterMode.deep_copy_and_change_dir()  
