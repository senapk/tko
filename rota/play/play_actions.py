...
from rota.cmds.cmd_down import DownProblem

from rota.play.fmt import Fmt
from rota.play.floating import Floating, FloatingGrade
from rota.play.gui import Gui
from rota.play.opener import Opener

from rota.play.tasktree import TaskAction
...
class PlayActions:
    ...
    def __down_remote_task(self, task: Task):
        ...
        # down_frame.put_text(f"\nrota down {self.rep.alias} {task.key} -l {lang}\n")
