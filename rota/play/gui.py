from rota.play.keys import GuiActions, GuiKeys
from rota.game.xp import XP
from rota.play.opener import Opener
from rota.settings.settings import Settings
from rota.util.text import Text, Token,  RToken
...
from rota.play.search import Search
from rota.play.language_setter import LanguageSetter
from rota.play.images import opening, random_get
from rota.play.floating import Floating, FloatingInput
from rota.play.floating_manager import FloatingManager
from rota.play.flags import Flag, Flags, FlagsMan
from rota.play.tasktree import TaskTree
...
class Gui:
    ...
    def show_help(self):
        ...
        _help.put_sentence(Text() + RToken("g", "             rota config --editor <comando>"))
