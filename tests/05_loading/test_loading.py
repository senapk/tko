...
class Test:
    ...
    def test_run_mixed_5(self, capsys):
        Compare.text(capsys,  "out5", "-w 80 -m test cases.tio")
    def test_run_mixed_6(self, capsys):
        Compare.text(capsys,  "out6", "-w 80 -m test solver.py")
    def test_run_mixed_7(self, capsys):
        Compare.text(capsys,  "out7", "-w 80 -m test solver.py cases_empty.tio")
    def test_run_mixed_8(self, capsys):
        Compare.text(capsys,  "out8", "-w 80 -m test solver.py cases.tio")
