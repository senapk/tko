...
class Test:    
    def test_convert(self):
        ...
        assert str(res) == str(Text("{t}{f}", "abcde", "fghij"))
    
    def test_convert2(self):
        app = AppSettings()
        res = Border(app).build_bar("abcdefghij", 1, 10, "t", "f", round=False)
        assert str(res) == str(Text("{t}{f}", "abcdefghij", ""))
