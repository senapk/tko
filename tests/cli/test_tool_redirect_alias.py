from tko.cli.tool import _build_readme_candidates_from_repo_url
...
def test_build_readme_candidates_from_https_git_url() -> None:
    ...
    assert out == [
        "https://github.com/qxcodefup/arcade/blob/master/README.md",
...
def test_build_readme_candidates_from_https_plain_url() -> None:
    ...
    out: list[str] = _build_readme_candidates_from_repo_url(repo_url)
    assert out == [
        "https://github.com/qxcodepoo/arcade/blob/master/README.md",
...
def test_build_readme_candidates_from_git_ssh_url() -> None:
    ...
    out: list[str] = _build_readme_candidates_from_repo_url(repo_url)
    assert out == [
        "https://github.com/qxcodeed/arcade/blob/master/README.md",
