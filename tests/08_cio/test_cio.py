...
class Test:
    ...
    def test_cio_1(self, capsys): # type: ignore
        ...
        Compare.text(capsys, "out2", "-w 50 -m exec _calc.tio -d") 
        Compare.text(capsys, "out3", "-w 50 -m exec _calc.tio empty.py -d")
    ...
    def test_cio_2(self, capsys): # type: ignore
        ...
        Compare.text(capsys, "out5", "-w 50 -m exec _calc2.tio -d")
        Compare.text(capsys, "out6", "-w 50 -m exec _calc2.tio empty.py -d")
